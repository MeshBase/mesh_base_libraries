...
import static io.github.meshbase.mesh_base_core.ble.CommonConstants.CCCD_UUID;
import static io.github.meshbase.mesh_base_core.ble.CommonConstants.ID_UUID;
import static io.github.meshbase.mesh_base_core.ble.CommonConstants.MESSAGE_UUID;
import static io.github.meshbase.mesh_base_core.ble.CommonConstants.SERVICE_UUID;
  ...
  private final BluetoothGattCallback gattCallback = new BluetoothGattCallback() {
    ...
    public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
      ...
      try {
        ...
        idCharacteristic = gatt.getService(SERVICE_UUID).getCharacteristic(ID_UUID);
